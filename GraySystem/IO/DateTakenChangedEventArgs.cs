...
{
    public class DateTakenChangedEventArgs : AttributeChangedEventArgs
    {
        #region Constructors
        ...
        public override string ToString()
        {
            ...
            {
                return ("Successfully updated the date taken of " + _sOriginalAttributeValue + " to " + _sNewAttributeValue);
            } // end if
            else
            {
                return ("Failed to update the date taken of " + _sOriginalAttributeValue + " to " + _sNewAttributeValue +
