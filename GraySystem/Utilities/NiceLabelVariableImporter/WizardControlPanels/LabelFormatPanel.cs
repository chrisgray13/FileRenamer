...
namespace ICS.Utilities.NiceLabelVariableImporter.WizardControlPanels
{
   /// <summary>
   /// </summary>
   public partial class LabelFormatPanel : ICS.GUI_Library.Controls.WizardControlPanels.WizardControlPanel
   {
      #region Properties

      #region LabelFormatFilePath

      public string LabelFormatFilePath
      {
         get { return (_txtToFilePath.Text); }
      } // end LabelFormatFilePath property
      ...
      /// </summary>
      protected LabelFormatPanel() : base()
      {
         InitializeComponent();
      ...
      private void GetFilePathFromFileDialog(object sender, EventArgs e)
      {
         ...
         openFileDialog.Filter = "NiceLabel Label Format (*.lbl)|*.lbl";
         openFileDialog.Multiselect = false;
         if (openFileDialog.ShowDialog(this) == DialogResult.OK)
         {
            _txtToFilePath.Text = openFileDialog.FileName;
         } // end if
      ...
      private bool ValidateLabelFormatFilePath(ICS.GUI_Library.Controls.WizardControlPanels.WizardControlPanel sender, EventArgs e)
      {
         if (_txtToFilePath.Text.Length == 0)
         {
            RtlMessageBox.Show(String.Empty, String.Empty);

            return (false);
         } // end if
         else if (System.IO.File.Exists(_txtToFilePath.Text))
         {
            return (true);
         } // end else if
         else
      ...
      } // end ValidateLabelFormatFilePath
      ...
      protected override string ConstructSummary()
      {
         ...
         sSummary.AppendLine("   NiceLabel Label Format:");
         sSummary.AppendLine("      " + _txtToFilePath.Text);
